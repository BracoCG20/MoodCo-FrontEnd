import { N as NoImageMetadata, Y as UnsupportedImageFormat, Z as AstroError, j as MissingSharp } from "./errors-data_Bt8YYxwE.mjs";
import { y as detector } from "./path_CETMzbbs.mjs";
import { i as resolveDefaultOutputFormat, n as baseService, r as parseQuality } from "./generic_CV2tD4el.mjs";
//#region node_modules/.pnpm/astro@7.2.4_@emnapi+core@1._d5020a5348550caf2d1e283882743078/node_modules/astro/dist/assets/services/sharp.js
var sharp;
var qualityTable = {
	low: 25,
	mid: 50,
...
async function loadSharp() {
	let sharpImport;
	try {
		sharpImport = (await import("./dist_cWCqnU7H.mjs")).default;
	} catch {
